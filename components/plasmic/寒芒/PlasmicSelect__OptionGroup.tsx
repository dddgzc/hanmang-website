...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: 7TW1ehljUvX/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: XB1ngE7srsy/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__fHcKt)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__tja6F)}
              />
            </React.Fragment>
          ),
          value: args.children
